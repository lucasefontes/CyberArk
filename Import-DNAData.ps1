...
$HashTableHardCodedCredential = @{Name="$HardCodedCredential";Expression={$_.$HardCodedCredential};Alignment="Center"}
    ...
    Function Get-DNAData {
        ...
        Write-Host ("Numbers from Windows Scan Sheet:
--------------------------------") -ForegroundColor Green
    ...
    Function Get-UniqueLocalAccount{
        ...
        [string]$ReportPath
            ...
            Write-Host ("Unique Local Accounts: $NumberOfLocalAccounts")
    ...
    Function Get-UniqueDomainAccount{
        ...
        [string]$ReportPath
            ...
            Write-Host("Unique Domain Accounts: $NumberOfDomainAccounts")
    ...
    Function Get-DisabledLocalAccount {
        param(
            ...
            Write-Host ("Disabled Local Accounts: $NumberOfDisabledAccounts | $PercentageDisabledLocalAccounts%")
    ...
    Function Get-DisabledDomainAccount{
        param(
            ...
            Write-Host ("Disabled Domain Accounts: $NumberOfDisabledAccounts | $PercentageDisabledDomainAccounts%")
    ...
    Function Get-CompliantLocalAccount{
        param(
            ...
            Write-Host ("Compliant Local Accounts: $NumberOfCompliantLocalAccounts | $PercentageCompliantLocalAccounts%")
    ...
    Function Get-CompliantDomainAccount{
        param(
            ...
            Write-Host ("Compliant Domain Accounts: $NumberOfCompliantDomainAccounts | $PercentageCompliantDomainAccounts%")
    ...
    Function Get-NonCompliantLocalAccount{
        param(
            ...
            Write-Host ("Non-Compliant Local Accounts: $NumberOfNonCompliantLocalAccounts | $PercentageNonCompliant%")
    ...
    Function Get-NonCompliantDomainAccount{
        param(
            ...
            Write-Host ("Non-Compliant Domain Accounts: $NumberOfNonCompliantDomainAccounts | $PercentageNonCompliantDomainAccounts%")
    ...
    Function Get-LocalServiceAccount {
        param(
            ...
            Write-Host ("Local Service Accounts: $LocalServiceAccounts")
    ...
    Function Get-DomainServiceAccount {
        param(
            ...
            Write-Host ("Domain Service Accounts: $DomainServiceAccounts")
    ...
    Function Get-ExpiredAccount {
        param(
            ...
            Write-Host ("Expired Local and Domain Accounts: $NumberOfExpiredAccounts")
    ...
    Function Get-LockedAccount {
        param(
            [Parameter(Mandatory = $true)]
            [string]$ReportPath
            )

            $ReportLockedAccounts = Join-Path "$ReportPath" "LockedAccounts.txt"

            $NumberOfLockedAccountsVar = $WindowsSheetData |
            Where-Object {$_.$AccountState -like "Locked*" -and $_.$AccountName -notlike "*Group*"}
            
            $NumberOfLockedAccounts = $NumberOfLockedAccountsVar.Count
            Write-Host ("Locked Accounts: $NumberOfLockedAccounts")
            
            $NumberOfLockedAccountsVar | Sort-Object -Property $PasswordAge -Descending | Format-Table -Property `
            $HashTableAccountName,$HashTableAccountState,$HashTablePasswordAge,$HashTableAccountType |
            Tee-Object -FilePath $ReportLockedAccounts | Out-Null

    }

    Get-LockedAccount -ReportPath $ReportPath
    ...
    Function Get-PrivilegedLocalAccount{
        param(
            ...
            Write-Host ("Privileged Local Accounts: $PrivilegeLocalAccountsVar")
    ...
    Function Get-PrivilegedDomainAccount{
        param(
            ...
            Write-Host ("Privileged Domain Accounts: $PrivilegeDomainAccountsVar")
